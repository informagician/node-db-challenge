...
Relational databases are group of tables serving as resource to an application. SQL is the query language to perform CRUD operations on relational databases.

- [ ] Why do tables need a `primary key`?

primary keys or primary keywords are the unique identifier of that record
...
Create a third table as a bridge table with foreign keys to parent tables.
